...
" mostra uma linha no lugar do cursor
set cursorline
hi CursorLine   cterm=NONE ctermbg=darkred ctermfg=white guibg=darkred guifg=white

" Abre a edição na ultima linha alterada
...
" Cria um cabeçalho para scripts python
function! InsertHeadPython()
    normal(1G)
    call append(0, "#!/usr/bin/env python ")
    call append(1, "# Criado em:" . strftime("%a %d/%b/%Y hs %H:%M"))
    call append(2, "# Autor: Sandro Alves - bmsandro@gmail.com")
    call append(3, "# Descrição do Script (python) :  ")
normal($)
endfun            
map <F3> :call InsertHeadPython()<cr>
...
function! InsertHeadBash()
    ...
    call append(1, "# Criado em:" . strftime("%a %d/%b/%Y hs %H:%M"))
    call append(2, "# Autor: Sandro Alves - bmsandro@gmail.com")
    call append(3, "# Descrição do Script:(bash) ")  
    normal($)
endfun
map <F4> :call InsertHeadBash()<cr>
